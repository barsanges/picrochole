...
{- |
   Module      : Engine.Reporting.FromArtillery.TestSpec
   Copyright   : Copyright (C) 2022 barsanges
   License     : GNU GPL, version 3
-}

module Engine.Reporting.FromArtillery.TestSpec ( spec ) where
...
spec :: Spec
spec = do
  it "artillery has a 2 hexes wide line of sight" $ do
    mpieces <- loadSomeDir "test/functional/Engine/Reporting/FromArtillery/"
    mexpected <- R.readReports "test/functional/Engine/Reporting/FromArtillery/expected-reports.json"

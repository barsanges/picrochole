...
{- |
   Module      : Engine.Turn.Encirclement.Hole.TestSpec
   Copyright   : Copyright (C) 2022 barsanges
   License     : GNU GPL, version 3
-}

module Engine.Turn.Encirclement.Hole.TestSpec ( spec ) where
...
spec :: Spec
spec = do
  it "units able to preserve some room are protected against encirclement" $ do
    mpieces <- loadSomeDir "test/functional/Engine/Turn/Encirclement/Hole/"
    mexpected <- readUnits "test/functional/Engine/Turn/Encirclement/Hole/expected-units.json"

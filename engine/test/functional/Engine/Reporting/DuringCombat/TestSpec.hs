...
{- |
   Module      : Engine.Reporting.DuringCombat.TestSpec
   Copyright   : Copyright (C) 2022 barsanges
   License     : GNU GPL, version 3
-}

module Engine.Reporting.DuringCombat.TestSpec ( spec ) where
...
spec :: Spec
spec = do
  it "during combat, the units have a 1 hex wide line of sight" $ do
    mpieces <- loadSomeDir "test/functional/Engine/Reporting/DuringCombat/"
    mexpected <- R.readReports "test/functional/Engine/Reporting/DuringCombat/expected-reports.json"
